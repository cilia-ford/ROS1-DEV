...
controller_interface::CallbackReturn .::on_init()
{
  ...
  try
  {
    param_listener_ = std::make_shared<my_robot_controller::ParamListener>(get_node());
  }
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&.::reference_callback, this, std::placeholders::_1));
...
PLUGINLIB_EXPORT_CLASS(
  controller_package::., controller_interface::ControllerInterface)
