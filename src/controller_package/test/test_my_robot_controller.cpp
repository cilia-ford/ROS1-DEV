...
#include "test_my_robot_controller.hpp"
...
using controller_package::CMD_MY_ITFS;
using controller_package::control_mode_type;
using controller_package::STATE_MY_ITFS;

class .Test : public .Fixture<Testable.>
{
};

TEST_F(.Test, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(.Test, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(.Test, deactivate_success)
{
  SetUpController();
...
TEST_F(.Test, reactivate_success)
{
  SetUpController();
...
TEST_F(.Test, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(.Test, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(.Test, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(.Test, publish_status_success)
{
  SetUpController();
...
TEST_F(.Test, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
