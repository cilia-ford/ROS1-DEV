...
#ifndef CONTROLLER_PACKAGE__VALIDATE_MY_ROBOT_CONTROLLER_PARAMETERS_HPP_
#define CONTROLLER_PACKAGE__VALIDATE_MY_ROBOT_CONTROLLER_PARAMETERS_HPP_
...
#endif  // CONTROLLER_PACKAGE__VALIDATE_MY_ROBOT_CONTROLLER_PARAMETERS_HPP_
